process blast {
    ...
    singularity exec genoflu_1.2.0.sif blastn -query ${input_fasta} -db ${database} -outfmt '6 qseqid sseqid stitle pident length mismatch gapopen qstart qend sstart send evalue bitscore' -max_target_seqs 1 -max_hsps 1 -evalue 1e-25 -num_threads 24 >> blast_out/blast_test.txt
    """
}
